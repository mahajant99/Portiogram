...
$users = mysqli_query($conn, "select * from user_form where occupation='Graphic Designer'");
...
<header class="header">
    ...
    <a data-aos="zoom-in-left" data-aos-delay="150" href="index.html" class="logo">Portiogram </a>
    <nav class="navbar">
