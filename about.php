...
$users = mysqli_query($conn, "select * from user_form where id=1 or id=2");
...
<section class="home" id="home">
    <div class="content">
        ...
        <h3 data-aos="fade-up" data-aos-delay="300">Know More About Us</h3>
    </div>
</section>
<!-- home section ends -->
...
<section class="footer">
    ...
    <div class="box-container">
        ...
        <div class="box" data-aos="fade-up" data-aos-delay="150">
            <a href="poriogram.php" class="logo">Portiogram </a>
            <br><br>
            <div class="share">
